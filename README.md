...
For details of how to apply our trained models, please refer to the 'Applying trained PSFGAN and GaMorNet on real AGN' section. **Here we will highlight sets of parameters that will be used when using our models:**
